...
import {fetchUserAttributes, autoSignIn, signIn, signUp, signOut, resetPassword, confirmResetPassword, fetchAuthSession} from "aws-amplify/auth";
...
export const AuthProvider = ({children, userData}) => {
    ...
    const forgotPasswordSubmit = async (username, code, newPassword) => {
        try {
            const res = await confirmResetPassword({username, confirmationCode: code, newPassword});
